...
namespace DictionaryBit.BL.Operations.Commands
{
    public sealed class StartCommand : CommandBase
    {
        ...
        public StartCommand(ITelegramBot telegramBot, RepositoryManager repositoryManager, IHttpContextAccessor httpContext)
        ...
        {
            await _botClient.SendTextMessageAsync(user.ChatId, $"Привет, ${user.UserName}. Я— бот, помогающий в изучении иностранных языков");
        }
    }
}
